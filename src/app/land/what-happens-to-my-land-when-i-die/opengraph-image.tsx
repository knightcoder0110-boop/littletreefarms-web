...
export const alt = "What Happens to My Land When I Die? — a guide for Canadian landowners from Little Tree Farm";
    ...
    <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", padding: "64px 72px", color: "#faf6f0", background: "linear-gradient(135deg, #3a241a 0%, #1a3a2a 55%, #0f2419 100%)", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 1010 }}>
          <div style={{ fontSize: 68, lineHeight: 1.02, letterSpacing: -2 }}>What Happens to My Land When I Die?</div>
          <div style={{ marginTop: 20, color: "rgba(250,246,240,.76)", fontFamily: "Arial, sans-serif", fontSize: 26 }}>Two futures for the same land — and the plan that decides between them</div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontFamily: "Arial, sans-serif", fontSize: 22 }}>
          <span>Little Tree Farm</span><span style={{ color: "#dbc398" }}>Wills · Estates · Stewardship</span>
        </div>
      </div>
    </div>,
    size,
