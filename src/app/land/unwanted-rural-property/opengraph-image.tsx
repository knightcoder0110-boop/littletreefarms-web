...
export const alt = "Options for Unwanted Rural Property in Canada — a practical guide from Little Tree Farm";
    ...
    <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", padding: "64px 72px", color: "#faf6f0", background: "linear-gradient(135deg, #3a241a 0%, #1a3a2a 55%, #0f2419 100%)", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 990 }}>
          <div style={{ fontSize: 76, lineHeight: 1.02, letterSpacing: -3 }}>Options for Unwanted Rural Property</div>
          <div style={{ marginTop: 22, color: "rgba(250,246,240,.76)", fontFamily: "Arial, sans-serif", fontSize: 26 }}>Keep · Sell · Gift · Donate · Bequeath · Stewardship</div>
        </div>
